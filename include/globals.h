...
void setClock();
void setSleepMode();
void setSPIPinsMenu(BruceConfigPins::SPIPins bus);
void setI2CPinsMenu(BruceConfigPins::I2CPins bus);
void setUARTPinsMenu(BruceConfigPins::UARTPins bus);
