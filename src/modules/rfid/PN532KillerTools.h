...
// Stub classes for PN532Killer
class PN532KillerCmd {
public:
    enum WorkMode { Reader };
    enum TagType { MFC1K };
    enum ReaderProtocol { HF_ISO14443A };
    enum SnifferType { MFKey32v2 };
};

class PN532Killer {
public:
    PN532Killer(HardwareSerial &serial) {}
};
